...
`shell-core` — ядро командной оболочки. Функционируя в нативной среде UNIX-подобные системы. Представлена низкоуровневая архитектура и механизмы работы интерактивного терминала, обеспечивая полный цикл выполнения пользовательских команд
