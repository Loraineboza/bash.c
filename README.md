# this is the shell core

`shell-core` — ядро командной оболочки. Функционируя в нативной среде UNIX-подобные системы. Представленая низкоуровневая архитектура и механизмы работы интерактивного терминала, обеспечивая полный цикл выполнения пользовательских команд
...
- `shell-demo.png` - изображение демонстрации работы shell
